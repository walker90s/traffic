...
public class TrafficProjectModelMacroType extends BaseObj {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6805075199589330084L;
	...
	public TrafficProjectModelMacroType() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public TrafficProjectModelMacroType(Integer id, Integer model_id, Integer model_year_type, Integer plan_type,
			String model_name, String model_desc,String shpData, String traffic_array_1, String traffic_array_2, String cosResult_1,
			String cosResult_2, String model_correct_1, String model_correct_2, String createTime, String updateTime,
			Integer yn) {
		super();
		this.id = id;
	...
	public String getShpData() {
		return shpData;
	}

	public void setShpData(String shpData) {
		this.shpData = shpData;
	}
